...
<div class="container-fluid">
    ...
    <div class="col-md-10">
    	<h4 class="my-2"><b>Admin Dashboard<b></h4>
    			...
    			<div class="col-md-3 bg-success mx-2" style="height:130px">
    				<div class="col-md-12">
    					<div class="row">
    						<div class="col-md-8">
    							<?php 
    							 $ad=mysqli_query($conn,"SELECT * FROM queries");
    							 $num=mysqli_num_rows($ad);
    							 ?>
    							<h5 class="my-2 text-white text-center" style="font-size: 30px;"><?php echo $num; ?></h5>
    							<h5 class="text-white">Total</h5>
    							<h5 class="text-white">Queries</h5>
    						</div>
    						<div class="col-md-4">
    							<a href="query.php"><i class="fa fa-question-circle fa-3x my-4" style="color:white;"></i></a>
    						</div>
    				...
    				<div class="col-md-12">
    					<div class="row">
    						<div class="col-md-8">
                                ...
                                $re = mysqli_query($conn,"SELECT * FROM report");
