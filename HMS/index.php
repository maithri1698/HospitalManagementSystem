			...
			<!--start-image-slider---->
					<div class="image-slider">
					    ...
					    <ul class="rslides" id="slider1">
					      <li><img src="images/slider-image1.jpg" alt="" height="1px"></li>
					      <li><img src="images/slider-image2.jpg" alt="" height="1px"></li>
					      <li><img src="images/slider-image1.jpg" alt="" height="1px"></li>
					    </ul>
						 <!-- Slideshow 2 -->
					</div>
					<!--End-image-slider---->
		    <div class="clear"> </div>
		    <div class="content-grids" style="min-width: 300px;">
		    	<div class="wrap">
